/*
  ...
  Las categorías fueron definidas por vos, no por el Excel.
  Los precios marcados como null quedan "Consultar precio" hasta confirmar el dato.
*/
...
export const products = [
  // PLÁSTICO — mínimo 4
  { id:"allegra", name:"Silla Allegra", category:"plastico", price:22000, min:4, description:"Silla plástica. Disponible según colores en stock.", images:["allegra-1.jpg","allegra-2.jpg"] },
  { id:"roma-blanca", name:"Silla Roma Blanca", category:"plastico", price:22000, min:4, description:"Silla plástica.", images:["roma-blanca-1.jpg"] },
  { id:"roma-negra", name:"Silla Roma Negra", category:"plastico", price:22000, min:4, description:"Silla plástica.", images:["roma-negra-1.jpg"] },
  { id:"tulip", name:"Pack Tulip x4", category:"plastico", price:150000, min:1, description:"Pack de 4 sillas.", images:["tulip-1.jpg"] },
  { id:"eames", name:"Eames", category:"plastico", price:100000, min:4, description:"Silla Eames.", images:["eames-1.jpg"] },
  { id:"milan", name:"Milan", category:"plastico", price:100000, min:4, description:"Silla Milan.", images:["milan-1.jpg"] },
  ...
  // MADERA — clasificación corregida por vos
  ...
  { id:"milan-madera", name:"Milan", category:"madera", price:100000, min:1, description:"Producto clasificado en Madera según indicación.", images:["milan-madera-1.jpg"] },
  ...
  // YUTE / ENTRELAZADAS — clasificación corregida por vos
  ...
  { id:"moler-entrelazado-yute", name:"Moler entrelazado", category:"yute", price:110000, min:1, description:"Si esta versión corresponde a Yute, se puede mover aquí.", images:["moler-1.jpg"] },
  ...
  // OFICINA / GAMER
  { id:"gamer-roja", name:"Gamer Roja", category:"oficina", price:110000, min:1, description:"Silla gamer.", images:["gamer-roja-1.jpg"] },
  { id:"gamer-negra", name:"Gamer Negra", category:"oficina", price:120000, min:1, description:"Silla gamer.", images:["gamer-negra-1.jpg"] },
  ...
  // COMBOS — no se publican mesas individuales
